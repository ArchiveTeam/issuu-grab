...
wget.callbacks.get_urls = function(file, url, is_css, iri)
  ...
  if allowed(url)
    ...
    if item_type == "issue"
      ...
      check("https://issuu.com/rdr?p=1&r=https%3A%2F%2Fissuu.com%2F" .. item_user .. "&d=" .. item_issue .. "&u=" .. item_user)
      check("https://issuu.com/rdr?p=1&d=" .. item_issue .. "&u=" .. item_user)
...
--      check("https://issuu.com/call/document-page/stream/more-from-publisher/" .. item_user .. "/" .. item_issue .. "?experiment=see-more-ctrl,iab-category-new")
--      check("https://issuu.com/call/document-page/stream/more-from-others/" .. item_user .. "/" .. item_issue .. "?experiment=see-more-ads,iab-category-new")
--      check("https://issuu.com/call/document-page/stream/more-from-others/" .. item_user .. "/" .. item_issue .. "?experiment=see-more-ctrl,iab-category-new")
--      check("https://issuu.com/call/document-page/stream/suggestions-for-you/" .. item_user .. "/" .. item_issue .. "?experiment=see-more-ads,iab-category-new")
--      check("https://issuu.com/call/document-page/stream/suggestions-for-you/" .. item_user .. "/" .. item_issue .. "?experiment=see-more-ctrl,iab-category-new")
--      check("https://issuu.com/call/document-page/stream/more-from-publisher/" .. item_user .. "/" .. item_issue)
--      check("https://issuu.com/call/document-page/stream/more-from-others/" .. item_user .. "/" .. item_issue)
--      check("https://issuu.com/call/document-page/stream/suggestions-for-you/" .. item_user .. "/" .. item_issue)
